...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('foros_foros', (
            ...
            ('creacion', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0))),
        ...
        db.create_table('foros_aportes', (
            ...
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 2, 12, 0, 0))),
            ('contenido', self.gf('ckeditor.fields.RichTextField')()),
    ...
    models = {
        ...
        'foros.aportes': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 12, 0, 0)'}),
        ...
        'foros.foros': {
            ...
            'creacion': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 2, 12, 0, 0)'}),
