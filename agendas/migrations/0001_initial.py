...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Agendas'
        db.create_table('agendas_agendas', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('evento', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal('agendas', ['Agendas'])


    def backwards(self, orm):
        # Deleting model 'Agendas'
        db.delete_table('agendas_agendas')
